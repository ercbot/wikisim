...
const EXAMPLE_PROMPTS = {
  ...
  "Astral Projection Tea": "A tea ceremony that allows the drinker to split body from soul with a sip from a special blend",
  ...
  "Everywhen Bazaar": "A bazaar where the same object can be bought at different points during its existence",
  ...
  "Fine Aged Magic": "Spells that must be aged like wine before they can be cast",
