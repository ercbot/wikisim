...
export function calculatePositionWithGutterById(
  ...
  return calculatePositionWithGutter(rect as Rect, objectWidth, viewportWidth, gutter);
}
...
export function elide(string: string, length: number = 140, emptyState: string = '...') {
  if (isEmpty(string)) {
    return emptyState;
  }
